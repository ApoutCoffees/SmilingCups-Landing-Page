...
var ue2 = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = z(t2, k2) ? t2 : `{${t2}}`;
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g3 = m2[u], f2 = ve(g3), p3 = z(u, a2) ? Q2(d2) : Q2(d2, ee(u));
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t2, { colorScheme: R3, extend: T2, css: j } = m2, O2 = v3(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M } = d2, z3 = v3(d2, ["colorScheme"]), u = R3 || {}, { dark: V } = u, L = v3(u, ["dark"]), g3 = M || {}, { dark: te } = g3, re = v3(g3, ["dark"]), K3 = s(O2) ? this._toVariables({ [y3]: h(h({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y3]: h(h({}, L), re) }, r) : {}, X = s(V) ? this._toVariables({ [y3]: h(h({}, V), te) }, r) : {}, [G2, U3] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H, W2] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q2 = this.transformCSS(y3, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H, "dark", "variable", r, i2, a2, n);
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = z(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m2)}` : oe2(m2), g3 = c2 ? `${c2}.${m2}` : m2;
      i(d2) ? n(d2, u, g3) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x2 = {}, p3 = []) => {
  ...
  if (s(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c2.reduce((m2, { type: d2, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d2, t2)), m2), "") : C2(l2 != null ? l2 : ":root,:host", t2);
    }
    if (o) {
...
//# sourceMappingURL=chunk-U72LJQ5O.js.map
